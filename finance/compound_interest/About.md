...
Грубо говоря, все деньги, что вы получили с инвестирования, вы обратно инвестируете
...
Тогда, как показывают многие графики, конечная сумма денег на счете и доход будет расти по экспоненте.

![](./images/popular_cucl.png)

![](./images/popular_cucl_2.png)
...
Большие числа - результат работы инфляции. 

Реальный капитал тоже растет по экспоненте, но делает он это настолько долго (горизонт 40 лет для преумножения капитала), что такой метод инвестирования обретает высокие риски. Из-за политической составляющей, скачущего коэффициента инфляции, проблемы с планированием на 40 лет вперед.

Если же рассматривать сложный процент как инструмент <u>сохранения капитала</u>, то он работает всегда, на коротком сроке и очень даже неплохо
